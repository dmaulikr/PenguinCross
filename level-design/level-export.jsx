...
var pondWidth = 12, pondHeight = 8;


(function main() {  
  var pond = {
    name: app.activeDocument.name.replace(".psd", ""), 
    start: [0,0], 
    eggs: [], 
    ice: []
  };
  ...
  eachPixelInLayer("ice", function(x,y,rgb) {
    pond.ice.push([x,y]);
  });

  eachPixelInLayer("eggs", function(x,y,rgb) {
    pond.eggs.push([x,y]);
  });

  eachPixelInLayer("start", function(x,y,rgb) {
    pond.start = [x,y];
  });
